...
// import { getDeviceMetrics, getDevices } from "../../services/api";
...
// function MetricProperties({selectedBlock, updateNodeStyle, updateConfig, updateDevice, moveNode, deleteNode, parentId, index, isFirst, isLast}: MetricPropertiesProps) {
...
//     useEffect(() => {//update metrics
//         const deviceId = selectedBlock?.props?.config?.deviceId;
//         if(!deviceId){
//         return;
//         }
//         getDeviceMetrics(deviceId).then((metrics)=>{setAvailableMetrics(metrics);});
...
//             <DataSection selectedBlock={selectedBlock} devices={devices} availableMetrics={availableMetrics} updateConfig={updateConfig} updateDevice={updateDevice} showSecondaryMetric={false}/>        
                    
//             <TimeSection selectedBlock={selectedBlock} updateConfig={updateConfig} timeBuckedAvailable={false}/>                
