...
function DateTimeBlock({block, setSelectedContainerId, selectedBlockId, setSelectedBlockId, parentContainerId, deleteNode}:DateTimeBlockProps){
...
>
      {block.props.date && date.toLocaleDateString()}
      <br/>
      {block.props.time && date.toLocaleTimeString()}
    </p>
<button
    onClick={(e) => {
        e.stopPropagation();
