...
function HeadingBlock({block, index, updateNodeProp, setSelectedContainerId, selectedBlockId, setSelectedBlockId, parentContainerId, deleteNode}:HeadingBlockProps){
  ...
  onDoubleClick={() => setIsEditing(true)}           
            >
        <h1 key={block.id} ref={(node)=>{setNodeRef(node); setDropRef(node);}} className="transition-shadow duration-150"
